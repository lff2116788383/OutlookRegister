...
class MainWindow(QMainWindow):
    ...
    def _build_config_tab(self) -> None:
        ...
        self.oauth_retry_interval_input = QSpinBox()
        self.oauth_retry_interval_input.setRange(0, 300)
        self.oauth_initial_wait_seconds_input = QSpinBox()
        self.oauth_initial_wait_seconds_input.setRange(0, 60)
        self.oauth_callback_timeout_handled_seconds_input = QSpinBox()
        self.oauth_callback_timeout_handled_seconds_input.setRange(1, 120)
        self.oauth_callback_timeout_unhandled_seconds_input = QSpinBox()
        self.oauth_callback_timeout_unhandled_seconds_input.setRange(1, 120)
        self.oauth_callback_timeout_retry_handled_seconds_input = QSpinBox()
        self.oauth_callback_timeout_retry_handled_seconds_input.setRange(1, 120)
        self.oauth_callback_timeout_retry_unhandled_seconds_input = QSpinBox()
        self.oauth_callback_timeout_retry_unhandled_seconds_input.setRange(1, 120)
        ...
        oauth_form.addRow("OAuth 初始等待(秒)", self.oauth_initial_wait_seconds_input)
        oauth_form.addRow("首次回调等待-已处理(秒)", self.oauth_callback_timeout_handled_seconds_input)
        oauth_form.addRow("首次回调等待-未处理(秒)", self.oauth_callback_timeout_unhandled_seconds_input)
        oauth_form.addRow("二次回调等待-已处理(秒)", self.oauth_callback_timeout_retry_handled_seconds_input)
        oauth_form.addRow("二次回调等待-未处理(秒)", self.oauth_callback_timeout_retry_unhandled_seconds_input)
    ...
    def _load_config_to_form(self, config_path: Path | None = None, show_popup: bool = True) -> None:
        ...
        self.oauth_retry_attempts_input.setValue(config.oauth2.retry_attempts)
        self.oauth_retry_interval_input.setValue(config.oauth2.retry_interval_seconds)
        self.oauth_initial_wait_seconds_input.setValue(config.oauth2.initial_wait_seconds)
        self.oauth_callback_timeout_handled_seconds_input.setValue(config.oauth2.callback_timeout_handled_seconds)
        self.oauth_callback_timeout_unhandled_seconds_input.setValue(config.oauth2.callback_timeout_unhandled_seconds)
        self.oauth_callback_timeout_retry_handled_seconds_input.setValue(config.oauth2.callback_timeout_retry_handled_seconds)
        self.oauth_callback_timeout_retry_unhandled_seconds_input.setValue(config.oauth2.callback_timeout_retry_unhandled_seconds)
    ...
    def _build_config_from_form(self) -> AppConfig:
        ...
        config.oauth2.retry_attempts = self.oauth_retry_attempts_input.value()
        config.oauth2.retry_interval_seconds = self.oauth_retry_interval_input.value()
        config.oauth2.initial_wait_seconds = self.oauth_initial_wait_seconds_input.value()
        config.oauth2.callback_timeout_handled_seconds = self.oauth_callback_timeout_handled_seconds_input.value()
        config.oauth2.callback_timeout_unhandled_seconds = self.oauth_callback_timeout_unhandled_seconds_input.value()
        config.oauth2.callback_timeout_retry_handled_seconds = self.oauth_callback_timeout_retry_handled_seconds_input.value()
